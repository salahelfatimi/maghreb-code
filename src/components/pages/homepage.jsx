...
export default function Homepage(){
    ...
    return(
        ...
        <div  id="home" className="flex flex-col  pt-24  gap-14 items-center  h-screen    bg-cover bg-top  bg-[url('/bgtop.png')]  ">
                ...
                <div className=" select-none flex flex-col justify-center  items-center   gap-6 ">
                    ...
                    <button onClick={()=>(handleClick())} className=" bg-white border-[#B3D12F] border-4 lg:px-8 px-4 py-2  font-semibold lg:text-2xl rounded-full text-[#B3D12F] hover:bg-[#303030] duration-700">Explore Our Services</button>
                </div>
